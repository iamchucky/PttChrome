...
TermView.prototype = {
  ...
  setupPicPreviewOnHover: function() {
    var self = this;
    var aNodes = $(".main a[href^='http://ppt.cc/'], .main a[type='p'], .main a[href^='http://imgur.com/'], .main a[href^='https://imgur.com/'], .main a[href^='http://m.imgur.com/'], .main a[href^='https://m.imgur.com/'], .main a[href^='https://flic.kr/p/'], .main a[href^='https://www.flickr.com/photos/']")
    ...
    var onover = function(elem) {
      ...
      if (found_flickr) {
        ...
        return function(e) {
          ...
          var src = (type == 'p') ? href : (href.indexOf('imgur.com') > 0) ? href.replace(/(http(s)?):\/\/(m\.)?imgur.com/, "$1://i.imgur.com") + '.jpg' : href + '@.jpg';
          setPicPreviewSrc(src);
        };
      }
    };
  ...
  embedPicAndVideo: function() {
    var aNodes = $(".main a[type='p'], .main a[href^='http://imgur.com/'], .main a[href^='https://imgur.com/'], .main a[href^='http://m.imgur.com/'], .main a[href^='https://m.imgur.com/'], .main a[href^='https://flic.kr/'], .main a[href^='https://www.flickr.com/photos/']");
    ...
    for (var i = 0; i < aNodes.length; ++i) {
      ...
      if (found_flickr) {
        ...
        if (isImgurAlbum) {
          ...
          var src = (type == 'p') ? href : (href.indexOf('imgur.com') > 0) ? href.replace(/(http(s)?):\/\/(m\.)?imgur.com/, "$1://i.imgur.com") + '.jpg' : '';
          if (src) {
            var imgNode = document.createElement('img');
            imgNode.setAttribute('class', 'easyReadingImg');
            imgNode.setAttribute('src', src);
